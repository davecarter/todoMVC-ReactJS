...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoMaker = function TodoMaker(props) {
	  var check = function check(e) {
	    if (e.key == 'Enter') {
	      props.addTodo({ text: e.target.value, done: false });
	      e.target.value = '';
	    }
	  };
	...
	var Todo = function (_React$Component) {
	  ...
	  _createClass(Todo, [{
	    ...
	    value: function handleChange() {
	      ...
	      // TODO: Change localStorage with the new done value
	    }
	  }, {
	    key: 'handleClick',
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'view' },
	        _react2.default.createElement('input', { id: this.props.id, onChange: this.handleChange.bind(this), checked: this.state.done, className: 'toggle', type: 'checkbox' }),
	  ...
	  _createClass(TodoApp, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'todoapp' },
	        _react2.default.createElement(TodoMaker, { text: this.props.text, addTodo: this.addTodo.bind(this) }),
	        _react2.default.createElement(TodoList, { todos: this.state.todos, removeTodo: this.removeTodo.bind(this) }),
