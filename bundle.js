...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoMaker = function TodoMaker(props) {
	  ...
	  _createClass(Todo, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'view' },
	        _react2.default.createElement('input', { id: this.props.id, onChange: this.handleChange.bind(this), checked: this.props.done, className: 'toggle', type: 'checkbox' }),
	        _react2.default.createElement(
	          'label',
	          null,
	          this.props.text
	        ),
	        _react2.default.createElement('button', { onClick: this.handleClick.bind(this), className: 'destroy' })
	      );
	    }
	  }]);
	    ...
	    value: function render() {
	      ...
	      var todos = this.props.todos.map(function (todo, index) {
	        return _react2.default.createElement(
	          'li',
	          { key: index },
	          _react2.default.createElement(Todo, _extends({}, _this3.props, { id: index, done: todo.done, text: todo.text }))
	        );
	      });
	...
	var TodoApp = function (_React$Component3) {
	  ...
	  function TodoApp() {
	    ...
	    var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(TodoApp).call(this));
	  ...
	  _createClass(TodoApp, [{
	    ...
	    value: function handleChange(text) {
	      var newState = this.state.todos.map(function (todo) {
	        if (todo.text == text) {
	          return _extends({}, todo, { done: !todo.done });
	        }
	    ...
	    key: 'render',
	    value: function render() {
	      var itemsLeft = this.state.todos.filter(function (todo) {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'todoapp' },
	        _react2.default.createElement(TodoMaker, { text: this.props.text, onAddTodo: this.addTodo.bind(this) }),
	        _react2.default.createElement(TodoList, { todos: this.state.todos, onDone: this.handleChange.bind(this), onRemoveTodo: this.removeTodo.bind(this) }),
	        _react2.default.createElement(TodoFooter, { itemsLeft: itemsLeft })
	      );
	    }
	  }], [{
	    key: 'propTypes',
	...
	_reactDom2.default.render(_react2.default.createElement(TodoApp, { text: "What\'s need to be done" }), document.getElementById('app'));
